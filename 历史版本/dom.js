...
$.fn.extend({
    ...
    html: function( html ){
        ...
        * 2、没有传，则获取第一个元素，然后返回这个元素的innerHTML内容
        ...
        * */
        ...
        // 如果参数个数大于等于1，那么遍历所有的元素，分别设置其innerHTML值为传入的html
    ...
    _html: function( html ){
        ...
        // 如果传参了，那么遍历所有的元素，分别设置其innerHTML值为传入的html
        else{
            this.each( function(){
                // 这里的this指向遍历到的每一个元素
                this.innerHTML = html;
        ...
        * */
        ...
        this.each( function(){
            ...
            $selector.each( function( i ){
                ...
                // 这里的this指向每一个目的地元素，给目的地添加外面遍历的元素
    ...
    prepend: function( context ){
        ...
        // 如果不是字符串，则把$context的每一项添加到this的每一项的最前面
        else{
