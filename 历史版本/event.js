...
$.fn.extend({
    ...
    on: function( type, fn ){
        ...
        * 6、如果有，直接把传递的回调push到对应事件的数组就可以了
        * 7、链式编程返回this
        * */
        this.each( function(){
            ...
            if( !this.$_event_cache[ type ] ){
                ...
                // 如果是第一个绑定事件，那么需要真正调用浏览器的方法进行事件绑定
                jQuery.addEvent( this, type, function( e ){
                    // console.log(this); 这里面的this IE8中指向window 正常浏览器指向绑定的DOM元素
    ...
    off: function( type, fn ){
        ...
        * */
        ...
        this.each( function(){
            ...
            // 没有绑定过任何事件，就不用处理了，跳出本次遍历，直接进入下次遍历
